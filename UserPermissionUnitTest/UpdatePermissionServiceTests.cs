...
namespace UserPermissionUnitTest
{
    public class UpdatePermissionServiceTests
    {
        ...
        public async Task UpdatePermission_Should_Update_PermissionStatus()
        {
            ...
            // Simulo el comportamiento de los métodos GetByNameAsync, UpdateAsync y SaveChangesAsync en IUnitOfWork
            ...
            // Realizo otras comprobaciones según la lógica de tu servicio
            return;
        }
    }
}